...
$_['entry_product_video']	=	'Присвоение видео к продуктам: ';
...
$_['entry_stock_status']	=	'Статус "Нет на складе":<br /><span class="help">При отсутствии товара (кол-во = 0) посетителям показывается выбранный статус (он может изменяться в настройках товара). Здесь можно задать значение по умолчанию (будет выбрано в списке при создании товаров).</span>';
...
$_['entry_config_sms_notifications']	=	'Уведомление о заказе через SMS <b>для клиента</b>:';
$_['entry_config_sms_notifications_admin']	=	'Уведомление о заказе через SMS <b>для администратора</b>:';
$_['entry_config_sms_text_customer']	=	'Текст сообщения для клиента';
$_['entry_config_sms_text_admin']	=	'Текст сообщения для администратора';
