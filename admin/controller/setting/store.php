...
class ControllerSettingStore extends Controller {
	...
	public function getForm() { 
		...
		$this->data['entry_config_sms_notifications'] = $this->language->get('entry_config_sms_notifications');
		...
		} elseif (isset($store_info['config_sms_notifications'])) {
			$this->data['config_sms_notifications'] = $store_info['config_sms_notifications'];	
		} else {
		...
		} elseif (isset($store_info['config_sms_notifications_login'])) {
			$this->data['config_sms_notifications_login'] = $store_info['config_sms_notifications_login'];	
		} else {
		...
		} elseif (isset($store_info['config_sms_notifications_password'])) {
			$this->data['config_sms_notifications_password'] = $store_info['config_sms_notifications_password'];	
		} else {
		...
		} elseif (isset($store_info['config_sms_notifications_sign'])) {
			$this->data['config_sms_notifications_sign'] = $store_info['config_sms_notifications_sign'];	
		} else {
