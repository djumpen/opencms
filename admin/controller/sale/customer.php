...
// 					$this->error['address_city'][$key] = $this->language->get('error_city');
				...
				if($this->config->get('use_countries_and_regions')) {
					...
					if(!isset($this->request->post['address'][$key]['postcode'])) {
						$this->request->post['address'][$key]['postcode'] = '';
					}
					$this->request->post['address'][$key]['country_id'] = '';
					$this->request->post['address'][$key]['zone_id'] = '';
					$this->request->post['address'][$key]['tax_id'] = '';
				}
			}
		}
