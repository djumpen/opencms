    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-authorizenet-aim" class="form-horizontal">
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-login"><?php echo $entry_login; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-hash"><?php echo $entry_hash; ?></label>
          <div class="col-xs-10">
            <input type="text" name="authorizenet_aim_hash" value="<?php echo $authorizenet_aim_hash; ?>" id="input-hash" class="form-control" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-server"><?php echo $entry_server; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-mode"><?php echo $entry_mode; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-method"><?php echo $entry_method; ?></label>
          <div class="col-xs-10">
