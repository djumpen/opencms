  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-payza" class="form-horizontal">
        ...
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-security"><?php echo $entry_security; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-callback"><?php echo $entry_callback; ?></label>
          <div class="col-xs-10">
