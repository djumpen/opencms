    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sagepay-us" class="form-horizontal">
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-merchant-id"><?php echo $entry_merchant_id; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-merchant-key"><?php echo $entry_merchant_key; ?></label>
          <div class="col-xs-10">
