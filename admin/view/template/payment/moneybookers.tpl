  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-moneybookers" class="form-horizontal">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-secret"><?php echo $entry_secret; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-canceled-status"><?php echo $entry_canceled_status; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-chargeback-status"><?php echo $entry_chargeback_status; ?></label>
          <div class="col-xs-10">
