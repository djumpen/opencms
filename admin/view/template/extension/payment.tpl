        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-left"><span<?php echo ($this->language->get('text_disabled') == $extension['status'])?' class="label label-warning"':' class="label label-primary"'; ?>><?php echo $extension['status'] ?></span></td>
