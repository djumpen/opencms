    ...
    <div class="panel-body">
      <form class="form-horizontal">
        <div class="form-group">
          <label class="col-xs-2 control-label" for="button-upload"><?php echo $entry_upload; ?> </label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label"><?php echo $entry_progress; ?></label>
          <div class="col-xs-10">
            <div class="progress">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label"><?php echo $entry_overwrite; ?></label>
          <div class="col-xs-10">
