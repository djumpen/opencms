      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-discount"><?php echo $entry_discount; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label"><?php echo $entry_logged; ?></label>
              <div class="col-xs-10">
		<div class="btn-group" data-toggle="buttons">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label"><?php echo $entry_shipping; ?></label>
              <div class="col-xs-10">
		<div class="btn-group" data-toggle="buttons">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-category"><?php echo $entry_category; ?></label>
              <div class="col-xs-10">
		 ...
		 <br />
            ...
            <div class="form-group">
              ...
              <div class="col-xs-10">
                <input name="date_start" value="<?php echo $date_start; ?>" id="input-date-start" class="form-control datepicker" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-date-end"><?php echo $entry_date_end; ?></label>
              <div class="col-xs-10">
                <input name="date_end" value="<?php echo $date_end; ?>" id="input-date-end" class="form-control datepicker" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-uses-total"><?php echo $entry_uses_total; ?> </label>
              <div class="col-xs-10">
                <input type="text" name="uses_total" value="<?php echo $uses_total; ?>" id="input-uses-total" class="form-control" />
		 </div>
            </div>
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-uses-customer"><?php echo $entry_uses_customer; ?> </label>
              <div class="col-xs-10">
