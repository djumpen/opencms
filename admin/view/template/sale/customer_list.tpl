  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-customer" formaction="<?php echo $approve; ?>" class="btn  btn-success"><i class="fa fa-check"></i> <?php echo $button_approve; ?></button>
          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              <tr class="filter">
                ...
                <td><input name="filter_date_added" value="<?php echo $filter_date_added; ?>" id="date" class="form-control datepicker" /></td>
                <td></td>
