      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-affiliate" class="form-horizontal">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-company"><?php echo $entry_company; ?></label>
              <div class="col-xs-10">
                <input type="text" name="company" value="<?php echo $company; ?>" id="input-company" class="form-control" />
              </div>
            </div>
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-address-1"><?php echo $entry_address_1; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-address-2"><?php echo $entry_address_2; ?></label>
              <div class="col-xs-10">
                <input type="text" name="address_2" value="<?php echo $address_2; ?>" id="input-address-2" class="form-control" />
              </div>
            </div>
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-city"><?php echo $entry_city; ?></label>
              <div class="col-xs-10">
          ...
          <div class="tab-pane" id="tab-payment">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-tax"><?php echo $entry_tax; ?></label>
              <div class="col-xs-10">
                <input type="text" name="tax" value="<?php echo $tax; ?>" id="input-tax" class="form-control" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-xs-2 control-label"><?php echo $entry_payment; ?></label>
              <div class="col-xs-10">
                <div class="btn-group" data-toggle="buttons">
...
-->
            ...
            <div id="payment-cheque" class="payment">
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-cheque"><?php echo $entry_cheque; ?></label>
                <div class="col-xs-10">
            ...
            <div id="payment-paypal" class="payment">
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-paypal"><?php echo $entry_paypal; ?></label>
                <div class="col-xs-10">
            ...
            <div id="payment-bank" class="payment">
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-bank-name"><?php echo $entry_bank_name; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="bank_name" value="<?php echo $bank_name; ?>" id="input-bank-name" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-bank-branch-number"><?php echo $entry_bank_branch_number; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="bank_branch_number" value="<?php echo $bank_branch_number; ?>" id="input-bank-branch-number" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-bank-swift-code"><?php echo $entry_bank_swift_code; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="bank_swift_code" value="<?php echo $bank_swift_code; ?>" id="input-bank-swift-code" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-bank-account-name"><?php echo $entry_bank_account_name; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="bank_account_name" value="<?php echo $bank_account_name; ?>" id="input-bank-account-name" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-bank-account-number"><?php echo $entry_bank_account_number; ?></label>
                <div class="col-xs-10">
          ...
          <div class="tab-pane" id="tab-transaction">
            ...
            <br />
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-description"><?php echo $entry_description; ?></label>
              <div class="col-xs-10">
