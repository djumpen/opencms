  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button id="button-send" class="btn btn-primary " onclick="send('index.php?route=sale/contact/send&token=<?php echo $token; ?>');"><i class="fa fa-envelope"></i> <?php echo $button_send; ?></button>
        </div>
    ...
    <div class="panel-body">
      <form class="form-horizontal">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-to"><?php echo $entry_to; ?></label>
          <div class="col-xs-10">
            <select name="to" id="input-to" class="form-control">
              ...
              <option value="cutsom_subscribers">Без учетной записи</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-subject"><?php echo $entry_subject; ?></label>
          <div class="col-xs-10">
