  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="tab-content">
        <div class="tab-pane active row" id="tab-order">
          <div class="col-xs-5">
          <table class="table table-striped table-bordered">
            ...
            <?php if($this->config->get('use_order_invoice_number')) { ?>
            <tr>
              <td><?php echo $text_invoice_no; ?></td>
              <td><?php if ($invoice_no) { ?>
                <?php echo $invoice_no; ?>
                <?php } else { ?>
                <button id="button-invoice" class="btn btn-success "><i class="fa fa-cog"></i> <?php echo $text_generate; ?></button>
                <?php } ?></td>
            </tr>
            <?php } ?>
            <!--
            ...
            <?php } ?>
            <?php if ($customer_group && $show_group) { ?>
            <tr>
            ...
            <tr>
              ...
              <td><?php echo $total; ?>
                ...
                <button id="button-credit-add" class="btn btn-success "><i class="fa fa-plus-circle"></i> <?php echo $text_credit_add; ?></button>
                <?php } else { ?>
                <button id="button-credit-remove" class="btn btn-danger "><i class="fa fa-minus-circle"></i> <?php echo $text_credit_remove; ?></button>
                <?php } ?>
                <?php } ?></td>
            </tr>
            ...
            <tr>
              ...
              <td><?php echo $reward; ?>
                <?php if (!$reward_total) { ?>
                <button id="button-reward-add" class="btn btn-success "><i class="fa fa-plus-circle"></i> <?php echo $text_reward_add; ?></button>
                <?php } else { ?>
                <button id="button-reward-remove" class="btn btn-danger "><i class="fa fa-minus-circle"></i> <?php echo $text_reward_remove; ?></button>
                <?php } ?></td>
            </tr>
            <?php } ?>
            <?php if ($order_status) { ?>
            ...
            <tr>
              ...
              <td><?php echo $commission; ?>
                ...
                <button id="button-commission-add" class="btn btn-success "><i class="fa fa-plus-circle"></i> <?php echo $text_commission_add; ?></button>
                <?php } else { ?>
                <button id="button-commission-remove" class="btn btn-danger "><i class="fa fa-minus-circle"></i> <?php echo $text_commission_remove; ?></button>
                <?php } ?></td>
            </tr>
            <?php } ?>
            <?php if($this->config->get('show_additinal_order_information')) { ?>
            <?php if ($ip) { ?>
            <tr>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-credit-add').replaceWith('<button id="button-credit-remove" class="btn btn-danger "><i class="fa fa-minus-circle"></i> <?php echo $text_credit_remove; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-credit-remove').replaceWith('<button id="button-credit-add" class="btn btn-success "><i class="fa fa-plus-circle"></i> <?php echo $text_credit_add; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-reward-add').replaceWith('<button id="button-reward-remove" class="btn btn-danger "><i class="fa fa-minus-circle"></i> <?php echo $text_reward_remove; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-reward-remove').replaceWith('<button id="button-reward-add" class="btn btn-success "><i class="fa fa-plus-circle"></i> <?php echo $text_reward_add; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-commission-add').replaceWith('<button id="button-commission-remove" class="btn btn-danger "><i class="fa fa-minus-circle"></i> <?php echo $text_commission_remove; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-commission-remove').replaceWith('<button id="button-commission-add" class="btn btn-success "><i class="fa fa-minus-circle"></i> <?php echo $text_commission_add; ?></button>');
			}
		}
	});
});
