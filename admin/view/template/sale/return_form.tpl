        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-return">
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-order-id"><?php echo $entry_order_id; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-date-ordered"><?php echo $entry_date_ordered; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-lastname"><span class="">*</span> <?php echo $entry_lastname; ?></label>
              <div class="col-xs-10">
          ...
          <div class="tab-pane" id="tab-product">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-model"><?php echo $entry_model; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-return-reason"><?php echo $entry_reason; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-opened"><?php echo $entry_opened; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-return-action"><?php echo $entry_action; ?></label>
              <div class="col-xs-10">
