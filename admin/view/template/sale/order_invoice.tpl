...
<link rel="stylesheet" type="text/css" href="view/javascript/bootstrap/css/bootstrap.min.css" /> 
</head>
<body>
<?php foreach ($orders as $order) { ?>
<div style="page-break-after: always;" class="print-content container">
  ...
  <table class="produc table table-bordered">
    <tr class="heading">
