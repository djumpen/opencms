    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-order" class="form-horizontal">
        <ul class="nav nav-tabs">
          ...
          <?php if($this->config->get('use_different_payment_and_delivery_information')) { ?>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-customer">
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-store"><?php echo $entry_store; ?></label>
              <div class="col-xs-10">
            ...
            <?php } else { ?>
            <input type="hidden" name="customer_group_id" value="<?php print (isset($customer_groups[0]) ? $customer_groups[0]['customer_group_id'] : 1) ?>" />
            <?php } ?>
            
            <?php if($this->config->get('use_different_payment_and_delivery_information') || (!$payment_firstname && $firstname)) { ?>
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-firstname"><?php echo $entry_firstname; ?></label>
              <div class="col-xs-10">
            ...
            <?php if($this->config->get('use_different_payment_and_delivery_information') || (!$payment_lastname && $lastname)) { ?>
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-lastname"><?php echo $entry_lastname; ?></label>
              <div class="col-xs-10">
            ...
            <?php if(!$this->config->get('use_different_payment_and_delivery_information')) { ?>
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-address"><?php echo $entry_address; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-payment-firstname"><?php echo $entry_firstname; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-lastname"><?php echo $entry_lastname; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-company"><?php echo $entry_company; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group company-id-display">
              <label class="col-xs-2 control-label" for="input-payment-company-id"><?php echo $entry_company_id; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group tax-id-display">
              <label class="col-xs-2 control-label" for="input-payment-tax-id"><?php echo $entry_tax_id; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-address-1"><?php echo $entry_address_1; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-address-2"><?php echo $entry_address_2; ?></label>
              <div class="col-xs-10">
                <input type="text" name="payment_address_2" value="<?php echo $payment_address_2; ?>" id="input-payment-address-2" class="form-control" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-city"><?php echo $entry_city; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
              <div class="col-xs-10 ">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-country"><?php echo $entry_country; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-payment-zone"><?php echo $entry_zone; ?></label>
              <div class="col-xs-10">
            ...
            <input type="hidden" name="shipping_firstname" value="<?php print ($shipping_firstname ? $shipping_firstname : 'Поле не заполнено'); ?>">
            <input type="hidden" name="shipping_lastname" value="<?php print ($shipping_lastname ? $shipping_lastname : 'Поле не заполнено'); ?>">
            <input type="hidden" name="shipping_company" value="<?php print ($shipping_company ? $shipping_company : 'Поле не заполнено'); ?>">
            <input type="hidden" name="shipping_address_1" value="<?php print ($shipping_address_1 ? $shipping_address_1 : 'Поле не заполнено'); ?>">
            <input type="hidden" name="shipping_address_2" value="<?php print ($shipping_address_2 ? $shipping_address_2 : 'Поле не заполнено'); ?>">
            <input type="hidden" name="shipping_city" value="<?php print ($shipping_city ? $shipping_city : 'Поле не заполнено'); ?>">
            <input type="hidden" name="shipping_postcode" value="<?php print ($shipping_postcode ? $shipping_postcode : 'Поле не заполнено'); ?>">
            <input type="hidden" name="shipping_country_id" value="<?php print ( $shipping_country_id ? $shipping_country_id : ( isset($countries[0]) ? $countries[0]['country_id'] : 1 ) ); ?>">
            <input type="hidden" name="shipping_zone_id" value="0">
            <!-- MUST BE HIDDEN -->
            <?php } ?>
          </div>
          <?php if($this->config->get('use_different_payment_and_delivery_information')) { ?>
          ...
          <div class="tab-pane" id="tab-shipping">
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-shipping-address"><?php echo $entry_address; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-shipping-firstname"><?php echo $entry_firstname; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-shipping-lastname"><?php echo $entry_lastname; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-shipping-company"><?php echo $entry_company; ?></label>
              <div class="col-xs-10">
                <input type="text" name="shipping_company" value="<?php echo $shipping_company; ?>" id="input-shipping-company" class="form-control" />
              </div>
            </div>
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-shipping-address-1"><?php echo $entry_address_1; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-shipping-address-2"><?php echo $entry_address_2; ?></label>
              <div class="col-xs-10">
                <input type="text" name="shipping_address_2" value="<?php echo $shipping_address_2; ?>" id="input-shipping-address-2" class="form-control" />
              </div>
            </div>
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-shipping-city"><?php echo $entry_city; ?></label>
              <div class="col-xs-10">
                <input type="text" name="shipping_city" value="<?php echo $shipping_city; ?>" id="input-shipping-city" class="form-control" />
              </div>
            </div>
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-shipping-postcode"><?php echo $entry_postcode; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-shipping-country"><?php echo $entry_country; ?></label>
              <div class="col-xs-10">
            ...
            <div class="form-group required">
              <label class="col-xs-2 control-label" for="input-shipping-zone"><?php echo $entry_zone; ?></label>
              <div class="col-xs-10">
          ...
          <div class="tab-pane" id="tab-product">
                ...
                <tbody id="product">
                  ...
                  <tr id="product-row<?php echo $product_row; ?>">
                    ...
                    <td class="text-right"><?php echo $order_product['quantity']; ?>
                      ...
                      <input type="hidden" name="order_product[<?php echo $product_row; ?>][time_cancel]" value="<?php echo $order_product['time_cancel']; ?>" />
                    </td>
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-quantity"><?php echo $entry_quantity; ?></label>
                <div class="col-xs-10">
          ...
          <div class="tab-pane" id="tab-voucher">
            ...
            <fieldset>
              ...
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-to-name"><?php echo $entry_to_name; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="to_name" value="" id="input-to-name" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-to-email"><?php echo $entry_to_email; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="to_email" value="" id="input-to-email" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-from-name"><?php echo $entry_from_name; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="from_name" value="" id="input-from-name" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-from-email"><?php echo $entry_from_email; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="from_email" value="" id="input-from-email" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-theme"><?php echo $entry_theme; ?></label>
                <div class="col-xs-10">
              ...
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-message"><?php echo $entry_message; ?></label>
                <div class="col-xs-10">
                  <textarea name="message" rows="5" id="input-message" class="form-control"></textarea>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-xs-2 control-label" for="input-amount"><?php echo $entry_amount; ?></label>
                <div class="col-xs-10">
          ...
          <div class="tab-pane" id="tab-total">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-shipping"><?php echo $entry_shipping; ?></label>
                <div class="col-xs-10">
              ...
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-payment"><?php echo $entry_payment; ?></label>
                <div class="col-xs-10">
              ...
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-coupon"><?php echo $entry_coupon; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="coupon" value="" id="input-coupon" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-voucher"><?php echo $entry_voucher; ?></label>
                <div class="col-xs-10">
                  <input type="text" name="voucher" value="" id="input-voucher" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-xs-2 control-label" for="input-reward"><?php echo $entry_reward; ?></label>
                <div class="col-xs-10">
		...
		if (item['option'] != '') {
			...
			for (i = 0; i < item['option'].length; i++) {
				...
				if (option['type'] == 'select') {
					...
					html += '  <label class="col-xs-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
				...
				if (option['type'] == 'checkbox') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-xs-2 control-label">' + option['name'] + '</label>';
					html += '  <div class="col-xs-10">';
				...
				if (option['type'] == 'text') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-xs-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-xs-10"><input type="text" name="option[' + option['product_option_id'] + ']" value="' + option['option_value'] + '" id="input-option' + option['product_option_id'] + '" class="form-control" /></div>';
					html += '</div>';					
				}
				...
				if (option['type'] == 'textarea') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-xs-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-xs-10"><textarea name="option[' + option['product_option_id'] + ']" rows="5" id="input-option' + option['product_option_id'] + '" class="form-control">' + option['value'] + '</textarea></div>';
					html += '</div>';
				}
				...
				if (option['type'] == 'date') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-xs-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-xs-10"><input type="date" name="option[' + option['product_option_id'] + ']" value="' + option['value'] + '" id="input-option' + option['product_option_id'] + '" class="form-control" /></div>';
					html += '</div>';
				}
				...
				if (option['type'] == 'datetime') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-xs-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-xs-10"><input type="datetime-local" name="option[' + option['product_option_id'] + ']" value="' + option['value'] + '" id="input-option' + option['product_option_id'] + '" class="form-control" /></div>';
					html += '</div>';					
				}
				...
				if (option['type'] == 'time') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-xs-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-xs-10"><input type="time" name="option[' + option['product_option_id'] + ']" value="' + option['value'] + '" id="input-option' + option['product_option_id'] + '" class="form-control" /></div>';
					html += '</div>';					
				}
			}
		...
		success: function(json) {
			...
			if (json['order_product'] != '') {
				...
				for (i = 0; i < json['order_product'].length; i++) {
					...
					html += '  <td class="text-right">' + product['quantity'] + '<input type="hidden" name="order_product[' + product_row + '][quantity]" value="' + product['quantity'] + '" />';
					
					if (product['time_cancel']){
						html += ' <input type="hidden" name="order_product[' + product_row + '][time_cancel]" value="'  + product['time_cancel'] + '" /> ';
					}
