      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
        ...
        <div class="tab-content">
              ...
              <div class="col-xs-10">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab-customer">
                    ...
                    <div class="form-group">
                      <label class="col-xs-2 control-label" for="input-confirm"><?php echo $entry_confirm; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group">
                      <label class="col-xs-2 control-label" for="input-newsletter"><?php echo $entry_newsletter; ?></label>
                      <div class="col-xs-10"><div class="btn-group" data-toggle="buttons">
  		...
  		<label class="btn btn-primary<?php if ($status == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" value="1" name="status" id="input-status" <?php if ($status == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($status == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" value="0" name="status" id="input-status" <?php if ($status == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
                      </div>
                    </div>
                  ...
                  <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                    ...
                    <div class="form-group required">
                      <label class="col-xs-2 control-label" for="input-firstname<?php echo $address_row; ?>"><?php echo $entry_firstname; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group required">
                      <label class="col-xs-2 control-label" for="input-lastname<?php echo $address_row; ?>"><?php echo $entry_lastname; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group">
                      <label class="col-xs-2 control-label" for="input-company<?php echo $address_row; ?>"><?php echo $entry_company; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group required">
                      <label class="col-xs-2 control-label" for="input-address-1<?php echo $address_row; ?>"><?php echo $entry_address_1; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group">
                      <label class="col-xs-2 control-label" for="input-address-2<?php echo $address_row; ?>"><?php echo $entry_address_2; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group required">
                      <label class="col-xs-2 control-label" for="input-city<?php echo $address_row; ?>"><?php echo $entry_city; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group required">
                      <label class="col-xs-2 control-label" for="input-postcode<?php echo $address_row; ?>"><?php echo $entry_postcode; ?></label>
                      <div class="col-xs-10">
                    ...
                    <?php if($this->config->get('use_countries_and_regions')) { ?>
                    <div class="form-group required">
                      <label class="col-xs-2 control-label" for="input-country<?php echo $address_row; ?>"><?php echo $entry_country; ?></label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group required">
                      <label class="col-xs-2 control-label" for="input-zone<?php echo $address_row; ?>"><?php echo $entry_zone; ?></label>
                      <div class="col-xs-10">
                    ...
                    <?php } ?>
                    <div class="form-group">
                      <label class="col-xs-2 control-label"><?php echo $entry_default; ?></label>
                      <div class="col-xs-10">
                        <label class="radio">
          ...
          <div class="tab-pane" id="tab-transaction">
            ...
            <br />
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-transaction-description"><?php echo $entry_description; ?></label>
              <div class="col-xs-10">
          ...
          <div class="tab-pane" id="tab-reward">
            ...
            <br />
            <div class="form-group">
              <label class="col-xs-2 control-label" for="input-reward-description"><?php echo $entry_description; ?></label>
              <div class="col-xs-10">
...
function addAddress() {	
	...
	html += '    <label class="col-xs-2 control-label" for="input-firstname' + address_row + '"><?php echo $entry_firstname; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][firstname]" value="" id="input-firstname' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group required">';
	html += '    <label class="col-xs-2 control-label" for="input-lastname' + address_row + '"><?php echo $entry_lastname; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][lastname]" value="" id="input-lastname' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group">';
	html += '    <label class="col-xs-2 control-label" for="input-company' + address_row + '"><?php echo $entry_company; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][company]" value="" id="input-company' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 

	html += '  <div class="form-group company_id_display">';
	html += '    <label class="col-xs-2 control-label" for="input-company-id' + address_row + '"><?php echo $entry_company_id; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][company_id]" value="" id="input-company-id' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 

	html += '  <div class="form-group">';
	html += '    <label class="col-xs-2 control-label" for="input-tax-id' + address_row + '"><?php echo $entry_tax_id; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][tax_id]" value="" id="input-tax-id' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 


	html += '  <div class="form-group required">';
	html += '    <label class="col-xs-2 control-label" for="input-address-1' + address_row + '"><?php echo $entry_address_1; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][address_1]" value="" id="input-address-1' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 		
	
	html += '  <div class="form-group">';
	html += '    <label class="col-xs-2 control-label" for="input-address-2' + address_row + '"><?php echo $entry_address_2; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][address_2]" value="" id="input-address-2' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group required">';
	html += '    <label class="col-xs-2 control-label" for="input-city' + address_row + '"><?php echo $entry_city; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][city]" value="" id="input-city' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group required">';
	html += '    <label class="col-xs-2 control-label" for="input-postcode' + address_row + '"><?php echo $entry_postcode; ?></label>';
	html += '    <div class="col-xs-10"><input type="text" name="address[' + address_row + '][postcode]" value="" id="input-postcode' + address_row + '" class="form-control" /></div>';
	html += '  </div>'; 
    <?php if($this->config->get('use_countries_and_regions')) { ?>
	html += '  <div class="form-group required">';
	html += '    <label class="col-xs-2 control-label" for="input-country' + address_row + '"><?php echo $entry_country; ?></label>';
	html += '    <div class="col-xs-10"><select name="address[' + address_row + '][country_id]" id="input-country' + address_row + '" onchange="country(this, \'' + address_row + '\', \'0\');" class="form-control">';
	...
	html += '  <div class="form-group required">';
	html += '    <label class="col-xs-2 control-label" for="input-zone' + address_row + '"><?php echo $entry_zone; ?></label>';
	html += '    <div class="col-xs-10"><select name="address[' + address_row + '][zone_id]" id="input-zone' + address_row + '" class="form-control"><option value="false"><?php echo $this->language->get('text_none'); ?></option></select></div>';
	html += '  </div>'; 
    <?php } ?>
	html += '  <div class="form-group">';
	html += '    <label class="col-xs-2 control-label"><?php echo $entry_default; ?></label>';
	html += '    <div class="col-xs-10"><label class="radio"><input type="radio" name="address[' + address_row + '][default]" value="1" /></label></div>';
	html += '  </div>'; 
