          ...
          <div class="row">
            <div class="col-xs-5">
              <div class="form-group">
                <label class="col-xs-12 control-label" for="input-date-start"><?php echo $entry_date_start; ?></label>
                <div class="col-xs-10">
                  <input name="filter_date_start" value="<?php echo $filter_date_start; ?>" id="input-date-start" class="form-control datepicker" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-xs-12 control-label" for="input-date-end"><?php echo $entry_date_end; ?></label>
                <div class="col-xs-10">
            ...
            <div class="col-xs-5">
              <div class="form-group">
                <label class="col-xs-12 control-label" for="input-group"><?php echo $entry_group; ?></label>
                <div class="col-xs-10">
