        ...
        <table id="route" class="table table-striped table-bordered table-hover">
          <thead>
            <tr>
              ...
              <td class="text-left">имя шаблона</td>
              <td></td>
            </tr>
          </thead>
          <tbody>
            ...
            <tr id="route-row<?php echo $route_row; ?>">
              ...
              <td class="text-left"><input type="text" name="layout_route[<?php echo $route_row; ?>][template]" value="<?php echo $layout_route['template']; ?>" placeholder="<?php echo ''; ?>" class="form-control" /></td>
...
function addRoute() {
	...
	html += '  <td class="text-left"><input type="text" name="layout_route[' + route_row + '][template]" value="" placeholder="" class="form-control" /></td>';
