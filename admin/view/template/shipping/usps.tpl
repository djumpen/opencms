    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-usps" class="form-horizontal">
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-user-id"><?php echo $entry_user_id; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label"><?php echo $entry_domestic; ?></label>
          <div class="col-xs-10">
            <div class="well">
              <div class="checkbox">
                <label>
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label"><?php echo $entry_international; ?></label>
          <div class="col-xs-10">
            <div class="well">
              <div class="checkbox">
                <label>
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-size"><?php echo $entry_size; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-container"><?php echo $entry_container; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-machinable"><?php echo $entry_machinable; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-tax-class"><?php echo $entry_tax; ?></label>
          <div class="col-xs-10">
