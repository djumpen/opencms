    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ups" class="form-horizontal">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-pickup"><?php echo $entry_pickup; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-packaging"><?php echo $entry_packaging; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-classification"><?php echo $entry_classification; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-origin"><?php echo $entry_origin; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-state"><?php echo $entry_state; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-quote-type"><?php echo $entry_quote_type; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label"><?php echo $entry_insurance; ?></label>
          <div class="col-xs-10">
                <div class="btn-group" data-toggle="buttons">
        ...
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-length"><?php echo $entry_dimension; ?></label>
          <div class="col-xs-10">
            <div class="row">
              <div class="col-xs-4">
