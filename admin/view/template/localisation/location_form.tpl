  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-location" class="form-horizontal">
        ...
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-geocode"><?php echo $entry_geocode; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-10"><img src="<?php echo $thumb; ?>" alt="" class="img-thumbnail" />
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label" for="input-open"><?php echo $entry_open; ?></label>
          <div class="col-xs-10">
