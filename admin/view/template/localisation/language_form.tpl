    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-language" class="form-horizontal">
        ...
        <div class="form-group">
          <label class="col-xs-2 control-label required" for="input-locale"><?php echo $entry_locale; ?></label>
          <div class="col-xs-10">
        ...
        <div class="form-group required">
          <label class="col-xs-2 control-label" for="input-directory"><?php echo $entry_directory; ?></label>
          <div class="col-xs-10">
