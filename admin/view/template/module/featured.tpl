...
$('input[name=\'product\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/product/autocomplete&filter_status=1&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
...
function addModule() {	
	...
	html += '  <td class="text-left"><input type="text" name="featured_module[' + module_row + '][image_width]" value="80" class="form-control" /> <input type="text" name="featured_module[' + module_row + '][image_height]" value="80" class="form-control" /></td>';	
