                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-10">
                    <select name="welcome_module[<?php echo $module_row; ?>][position]" id="input-position<?php echo $module_row; ?>" class="form-control">
                      ...
                      <option value="mainmenu" selected="selected">Mainemenu</option>
                      <?php } else { ?>
...
function addModule() {	
	...
	html += '        <label class="col-xs-2 control-label" for="input-description' + module_row + '-language<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?></label>';
	html += '        <div class="col-xs-10"><textarea name="welcome_module[' + module_row + '][description][<?php echo $language['language_id']; ?>]" id="input-description' + module_row + '-language<?php echo $language['language_id']; ?>"></textarea></div>';
	html += '      </div>'; 	
	html += '    </div>';
	<?php } ?>
	...
	html += '    <div class="col-xs-10"><select name="welcome_module[' + module_row + '][layout_id]" id="input-layout' + module_row + '" class="form-control">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '    <div class="col-xs-10"><select name="welcome_module[' + module_row + '][position]" id="input-position' + module_row + '" class="form-control">';
	...
	html += '    <div class="col-xs-10"><select name="welcome_module[' + module_row + '][status]" id="input-status' + module_row + '" class="form-control">';
	...
	html += '    <div class="col-xs-10"><input type="text" name="welcome_module[' + module_row + '][sort_order]" value="" id="input-sort-order' + module_row + '" class="form-control" /></div>';
	html += '  </div>';
	html += '</div>';
