...
function addModule() {	
	...
	html += '    <td class="left"><input type="text" class="form-control"  <input type="text" class="form-control" name="pavblogcomment_module[' + module_row + '][limit]" value="6" size="3" /></td>';
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td><?php echo $entry_layout; ?></td>';
	html += '      <td><select class="form-control" name="pavblogcomment_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select class="form-control" name="pavblogcomment_module[' + module_row + '][position]">';
	<?php foreach( $positions as $pos ) { ?>
	...
	html += '      <td><select class="form-control" name="pavblogcomment_module[' + module_row + '][status]">';
	...
	html += '      <td><input type="text" class="form-control" name="pavblogcomment_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
