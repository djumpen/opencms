    ...
    <div class="panel-heading">
      <div class="pull-right">
        ...
        <a href="<?php echo $cancel; ?>" class="btn btn-danger "><i class="fa fa-times"></i> <?php echo $button_cancel; ?></a></div>
            <h1 class="panel-title"><i class="fa fa-group"></i> <?php echo $heading_title; ?></h1>
    </div>
        ...
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="text-right"><input type="text" name="affiliate_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="form-control" /></td>
...
function addModule() {	
    ...
    html += '  </select></td>';
	html += '  <td class="text-right"><input type="text" name="affiliate_module[' + module_row + '][sort_order]" value="" class="form-control" /></td>';
