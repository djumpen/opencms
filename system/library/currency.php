...
class Currency {
	...
	public function format($number, $currency = '', $value = '', $format = true, $wrap = true) {
		...
		if($wrap) {
		    if($wrap === true) {
		        ...
		        $string .= '<' . $wrap . '>' . number_format(round($value, (int)$decimal_place), (int)$decimal_place, $decimal_point, $thousand_point) . '</' . $wrap . '>';
		    }
		} else {  
		  $string .= number_format(round($value, (int)$decimal_place), (int)$decimal_place, $decimal_point, $thousand_point);
		}
