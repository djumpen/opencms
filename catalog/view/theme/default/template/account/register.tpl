...
<div class="row"><?php echo $column_left; ?>
            ...
            <div class="content">
               ...
               <fieldset>
                ...
                <div class="form-group col-xs-8">
                    ...
                    <label class="col-xs-3 control-label" for="firstname">
                        <span class="text-danger">*</span>
                        <?php echo $entry_firstname; ?>
                    </label>
                    <div class="col-xs-9  control-label">
                        <input type="text" name="firstname" value="<?php echo $firstname; ?>" autofocus class="form-control" />
                    ...
                    <div class="form-group col-xs-8">
                        ...
                        <label class="col-xs-3 control-label" for="telephone">
                            <span class="text-error">*</span> <?php echo $entry_telephone; ?>
                        </label>

                        <div class="col-xs-9  control-label">
                            <input class="form-control" type="tel" name="telephone" value="<?php echo $telephone; ?>" />
                    ...
                    <div class="form-group col-xs-8">
                        ...
                        <label class="col-xs-3 control-label" for="address_1">
                    ...
                    <div class="form-group col-xs-8">
                        ...
                        <label class="col-xs-3 control-label" for="city">
            ...
            <div class="content" style="display: none;">
                ...
                <fieldset>
                    ...
                    <div class="form-group col-xs-8">
                        ...
                        <label class="col-xs-3 control-label" for="company">
        ...
        <div class="content">
         ...
         <fieldset>
            ...
            <div class="form-group col-xs-8">
                ...
                <label class="col-xs-3 control-label" for="confirm">
    ...
    <div class="content">
        ...
        <fielset>
            ...
            <div class="form-group col-xs-8">
                <label class="col-xs-3 control-label" for="newsletter"><?php echo $entry_newsletter; ?></label>
                <div class="col-xs-10 ">
