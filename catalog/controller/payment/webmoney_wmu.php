...
class ControllerPaymentWebmoneyWMU extends Controller {
	...
	$this->data['button_confirm'] = $this->language->get('button_confirm');
		...
		// Переменные
		$this->data['LMI_PAYEE_PURSE'] = $this->config->get('webmoney_wmu_merch_u');  // LMI_PAYEE_PURSE Номер кошелька
		...
		$this->data['description'] = 'Оплата за товары. Заказ №' . $this->data['order_id'];
